...
export const ko: Translation = {
	...
	[Key.commentsSubmitFailed]: "댓글을 등록하지 못했습니다. 잠시 후 다시 시도해 주세요.",
	...
	[Key.commentsCaptchaVerified]: "인증 코드가 확인되었습니다. 댓글이나 투표를 계속할 수 있습니다.",
	...
	[Key.commentsVoteFailed]: "투표를 전송하지 못했습니다. 잠시 후 다시 시도해 주세요.",
	...
	[Key.commentsValidationWebsiteInvalid]: "올바른 웹사이트 URL을 입력해 주세요.",
