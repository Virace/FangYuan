...
FangYuan (方圆) is a modern WordPress block theme based on Twenty Twenty-Five. It emphasizes simplicity and adaptability while adding enhanced frontend interactions and custom styling. The theme offers flexible design options with a variety of patterns for different page types, making it ideal for building personal blogs, professional portfolios, online magazines, or business websites. Built with modern development tools including Webpack and SCSS, it provides a solid foundation for further customization.
...
* Initial development version based on Twenty Twenty-Five
* Added frontend JavaScript interactions
* Implemented modern build process with Webpack
* Enhanced editor styles and frontend styling
* Added theme customizations and branding

== Copyright ==

FangYuan WordPress Theme, (C) 2025 Virace and contributors.
Based on Twenty Twenty-Five WordPress Theme, (C) 2024-2025 WordPress.org.
FangYuan is distributed under the terms of the GNU GPL.
...
License: GPL-3.0. License URI: http://www.gnu.org/licenses/gpl-3.0.html
